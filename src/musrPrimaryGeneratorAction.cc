...
void musrPrimaryGeneratorAction::setupCovariance()
{
  ...
  covarX *= (epsG_x * 1e-6); // convert mm.mrad to m.rad = m
...
void musrPrimaryGeneratorAction::GeneratePrimaries(G4Event *anEvent)
{
  ...
  particleGun->SetParticleMomentumDirection(G4ThreeVector(px*20*CLHEP::pi*CLHEP::pi, py*20*CLHEP::pi*CLHEP::pi, 40*CLHEP::pi*CLHEP::pi));
