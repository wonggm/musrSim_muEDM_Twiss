...
//--------- Material definitions ---------
 ...
 G4Material* resin = 
    new G4Material("Resin", density= 1.15*CLHEP::g/CLHEP::cm3, ncomponents=4);
  resin->AddElement(C, natoms=21);
  resin->AddElement(H, natoms= 25);
  resin->AddElement(O, natoms= 5);
  resin->AddElement(Cl, natoms= 1);
